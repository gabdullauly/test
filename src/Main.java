...
=======
        ...
        club.setName("PSG");
        club.setCountry("France");
        club.setRatingPoints(98);
        club.setPlayers(players);

        Club club1 = new Club("Chelsea", "England", 95, players1);
        Club club2 = new Club("Liverpool", "England", 97, players);
        Club club3 = new Club("Real Madrid", "Spain", 98, players1);

        Club[] clubs = {club, club1, club2, club3};
        for (int i=0; i< clubs.length; i++){
            System.out.println(clubs[i].toString());
            System.out.println();
        }
